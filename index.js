...
app.post('https://moneyapi.vercel.app/api/transaction', async(req,res)=>{
...
app.get('https://moneyapi.vercel.app/api/transactions', async(req,res)=>{
    await mongoose.connect('mongodb+srv://kharelpawannp:hktH4d3pJ9JxI35f@cluster0.g2ggnyb.mongodb.net/?retryWrites=true&w=majority')
    const transactions = await Transaction.find();
    res.json(transactions)
})
app.listen('https://moneyapi.vercel.app')
